<?php
require_once("config.php"); // se incluye el archivo config.php que contiene la conexión a la base de datos
...
$query = $dbConn->prepare($sql); // se prepara la consulta SQL que se va a ejecutar
